...
Текущий публичный сайт использует реальные данные состава, текущей войны и накопленной истории обычных КВ. Schema v2, immutable observations, reconciliation, manual evidence для первых двух старых войн и восстановленные public player metrics завершены. Рейтинг игроков и рекомендации состава не реализованы.
