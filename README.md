...
**Текущий статус:** информационный прототип опубликован через GitHub Pages; подготовлен draft-контракт состава `roster_v1_draft`.
...
Следующий исполняемый этап требует отдельного решения: выполнить безопасный API probe либо подготовить подтверждённый ручной снимок состава. Подключение реальных данных, API и последующие внешние изменения требуют отдельных разрешений.
