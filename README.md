...
**Текущий статус:** локальный информационный прототип сайта создан.

Проект не подключён к Clash of Clans API, реальные игровые данные отсутствуют, сборщик и расчёты не реализованы, GitHub Pages не настроен. Локальный прототип показывает назначение проекта, будущие разделы, структуру состава, краткие правила КВ и принципы приватности.
...
Следующий содержательный этап — определить подтверждённый источник состава и публичные поля базовой карточки игрока. Подключение реальных данных, API и публикация требуют отдельных разрешений.
