...
Текущий публичный сайт использует реальные данные состава, текущей войны и накопленной истории обычных КВ. Коррекция недельных пожертвований на public schema v2 реализована offline и ожидает controlled production validation: основная метрика будет показывать прямые игровые counters текущего состава вместо повторного суммирования deltas. History schema v2, immutable observations, reconciliation, manual evidence для первых двух старых войн и восстановленные public player metrics завершены. Рейтинг игроков и рекомендации состава не реализованы.
