...
Статус: локальная подготовка без API probe, токена, реального кланового тега и сетевого runtime-кода. Дата проверки официального портала: 2026-07-19.
...
После отдельного разрешения нужен authenticated review официальной Swagger-схемы или минимальный безопасный API probe с тестовым локальным storage. До него следует:
